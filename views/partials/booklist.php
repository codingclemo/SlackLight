<?php use SlackLight\ShoppingCart, SlackLight\Util; ?>
...
<table class="table">
  ...
  foreach ($books as $book):
    ...
    <tr>
      ...
      <td>
        &euro;<?php echo number_format($book->getPrice(), 2); ?>
      </td>
      <td class="add-remove">
		  <?php if ($inCart): ?>
            ...
            Util::action
			          (SlackLight\Controller::ACTION_REMOVE,
		  ...
		  <?php else: ?>
			...
			(SlackLight\Controller::ACTION_ADD, array('bookId' => $book->getId())); ?>">
