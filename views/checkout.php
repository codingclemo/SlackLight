			...
			<div class="panel-body">
				...
				<form class="form-horizontal" method="post" action="<?php echo Util::action(Bookshop\Controller::ACTION_ORDER); ?>">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="nameOnCard" name="<?php print
                  \Bookshop\Controller::CC_NAME; ?>" placeholder="Your name please!"
                     value="<?php echo htmlentities($nameOnCard); ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="cardNumber" class="col-sm-4 control-label">Card Number:</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="cardNumber" name="<?php print
				  \Bookshop\Controller::CC_NUMBER; ?>" placeholder="try '1234567891234567'" value="<?php echo htmlentities
              ($cardNumber); ?>">
						</div>
					</div>
					<div class="form-group">
